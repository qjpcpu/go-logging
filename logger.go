...
func (l *Logger) Critical(args ...interface{}) {
    l.log(CRITICAL, "%s", strings.TrimRight(fmt.Sprintln(args...), "\n"))
}
func (l *Logger) Criticalf(format string, args ...interface{}) {
    l.log(CRITICAL, "%s", fmt.Sprintf(format, args...))
}
...
func (l *Logger) Warning(args ...interface{}) {
    l.log(WARNING, "%s", strings.TrimRight(fmt.Sprintln(args...), "\n"))
}
func (l *Logger) Warningf(format string, args ...interface{}) {
    l.log(WARNING, "%s", fmt.Sprintf(format, args...))
}
...
func (l *Logger) Debug(args ...interface{}) {
    l.log(DEBUG, "%s", strings.TrimRight(fmt.Sprintln(args...), "\n"))
}
func (l *Logger) Debugf(format string, args ...interface{}) {
    l.log(DEBUG, "%s", fmt.Sprintf(format, args...))
}
